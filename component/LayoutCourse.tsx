    ...
    <>
      ...
      <div className="flex justify-center items-center space-x-6 my-24 py-12  bg-muted/50">
        {previousTocItem ? (
          ...
          >
            <span className="uppercase font-light text-transparent bg-linear-to-l to-fuchsia-300 from-blue-400 bg-clip-text">
              &larr; Previous
            </span>
        ...
        {nextTocItem && (
          ...
          >
            <span className="uppercase font-light text-transparent bg-linear-to-l from-fuchsia-300 to-blue-400 bg-clip-text">
              Next &rarr;
            </span>
