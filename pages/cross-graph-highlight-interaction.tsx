...
export default function Home() {
  return (
    ...
    >
      ...
      //
      */}
      <h2 id="definition">What is cross graph interaction</h2>
      <p>What it is.</p>
      <p>working example</p>
      <p>Why do we care?</p>
      ...
      //
      */}
      <h2 id="shared state">Naive solution: shared state</h2>
      <p>
        A first solution: a shared state. You defined a react state at the level
        of the component that wraps all your viz with <code>useState</code>:
      </p>
      ...
      <p>
        Then, for each shape item of the graph you're building, you check wether
        or not the shape should be highlighted, and changes the way it's
        rendered if so.
      </p>
      <p>
      ...
      //
      */}
      <h2 id="better">Improving rerendering</h2>{' '}
