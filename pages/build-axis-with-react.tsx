...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <AccordionSection
        title={"Building a bottom axis with React"}
        startOpen={true}
      >
        <p>
          The code snippet below builds a <code>AxisBottom</code> component. It
          is{" "}
          <TakeHome>
      ...
      <AccordionSection
        title={"Building a left axis with React"}
        startOpen={false}
      >
      ...
      <AccordionSection title={"Dealing with margins"} startOpen={true}>
        <p>
      ...
      <AccordionSection title={"Use the axes"} startOpen={true}>
        <p>
          Once you have the bottom and left axis component described above you
          just need to call them properly. You need to compute the bounds area
          by substracting the margins to the total svg area.
        </p>
        <p>
      ...
      <AccordionSection title={"Alternative: the d3 way"} startOpen={true}>
        <p>
          If you're a d3.js afficionados and want to deal with as little react
          as possible, you can still use the good old <code>axisBottom()</code>{" "}
          and <code>axisLeft()</code> methods of d3 and wrap them in a
