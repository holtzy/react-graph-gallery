...
export default function Home() {
  return (
    ...
    >
      ...
      //
      */}
      <h2 id="todo">Examples</h2>
      <p>
        Here is a list of nifty viz examples using shape morphism to transition
        between several viz types
      </p>
      <br />
      <ul className="ml-10">
        <li>
        ...
        <li>
          ...
          <a href="http://www.maartenlambrechts.com/">Maarten Lambrechts</a> for
          the Pudding.
        </li>
        <br />
        <li>
      ...
      */}
      ...
      //
      */}
      <h2 id="todo">What are we trying to do</h2>{' '}
      <p>
        Sometimes in dataviz we want to transition between 2 chart types, let's
        say between a pie chart and a barplot. This is pretty hard since the
        shapes used for those 2 charts are very different: arc versus rectangle.
      </p>
      <br />
      <p>
        This is still possible thanks to a few libraries. This post suggests to
        use <code>d3.js</code> to build the start and end svg path,{' '}
        <code>flubber</code>
      ...
      //
      */}
      <h2 id="todo">Shape morphism on the web: a review</h2>
      <p>
      ...
      <ul className="ml-10">
        <br />
        <li>
          <code>SMIL</code> (Synchronized Multimedia Integration Language) is a
          feature introduced in firefox 4, allowing to follow a motion path.
          Basically it means you can use an <code>animate</code> element in your
          svg that will support shape morphism.
          <br />
          Unfortunately, this feature is probably get deprecated soon.
          Furthermore, it supports transition only between shapes with the same
          number of nodes. <br />
          <LinkAsButton
            size="sm"
        ...
        <br />
        <li>
          <code>greenSock MorphSvg plugin</code>: a promising javascript library
          for shape morphism, widely cited on the internet. Supports shapes with
          different number of nodes. But it's not free and not open source.
          <br />{' '}
          <LinkAsButton size="sm" href="https://greensock.com/morphSVG" isFaded>
            Website
          </LinkAsButton>
          <LinkAsButton
            size="sm"
        ...
        <br />
        <li>
          <code>superformula</code> is a mathematic formula that can be used to
          describe many complex shapes. Using 6 numbers as parameters, this
          formula can build many complex shapes. Interpolating between 2 shapes
          becomes easy: we just have to interpolate those numbers. Problem: it
          does not work with any shape and building a chart from this formula is
          thus impossible.
          <br />{' '}
          <LinkAsButton
            size="sm"
        ...
        <br />
        <li>
          <code>d3-interpolate</code> is a d3 module that provides a variety of
          interpolation methods. It works for paths, even with different number
          of nodes. But when the shape 2 has more nodes than shape 1 it just
          adds some nodes to the end of the shape 1 path. This result in a{' '}
        ...
        <li>
          ...
          adds an interpolator optimized for SVG <code>path</code> elements. It
          works very well for path including segments only, but from my
      ...
      <p>
        ...
        <TakeHome>
          We need an open source library capable of interpolating any path, even
      ...
      //
      */}
      <h2 id="todo">Shape interpolation with flubber</h2>
      <p>
      ...
      //
      */}
      <h2 id="todo">Animating the transition with react spring</h2>
      <p>
      ...
      //
      */}
      <h2 id="todo">Pie chart to barplot transition</h2>
      <p>
        I knew nothing about shape morphism 3 weeks ago. It took me a lot of
        effort to browse the web and find what the most appropriate tools are.
        To avoid you the hassle, here is a quick summary:
      ...
      //
      */}
      <h2 id="todo">Violin to boxplot transition</h2>{' '}
      <p>
        I knew nothing about shape morphism 3 weeks ago. It took me a lot of
        effort to browse the web and find what the most appropriate tools are.
        To avoid you the hassle, here is a quick summary:
