...
export default function Home() {
  return (
    ...
    >
      ...
      //
      */}
      <h2 id="todo">What is a viz from the future?</h2>
      ...
      //
      */}
      <h2 id="todo">glowing div with box shadow</h2>
      <p>
      ...
      //
      */}
      <h2 id="todo">Glowing SVG with</h2>
      <p>How can I do.</p>
      ...
      <p>
        BUT, it does not work with inset, so we need another solution for inside
        shadow.
      </p>
      <ChartOrSandbox
