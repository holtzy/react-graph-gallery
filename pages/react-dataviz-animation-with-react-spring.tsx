...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      //
      */}
      <h2 id="todo">What is spring animation</h2>
      <p>
      ...
      //
      */}
      <h2 id="todo">Basic react spring animation</h2>
      <p>
        The best tool to build a spring animation in the react world is{' '}
        <a href="https://react-spring.io/">react-spring</a>, a library dedicated
        to it. If you're not familiar with it already you probably want to take
        a look at their <a href="https://react-spring.io/">home page</a>.
      </p>
      <p>
        Let's start with a basic example showing how to animate a very basic viz
        component that just renders a circle.
      </p>
      <ChartOrSandbox
      ...
      <ul>
        ...
        <li>
          if function, it returns an array of length 2. First item is the object
          mentionned above. item 2 is the api that controls the spring. api is
          used for imperative style
        </li>
      </ul>
