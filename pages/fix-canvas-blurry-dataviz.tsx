    ...
    >
      ...
      */}
      ...
      >
        ...
        <p>
          ...
          screen this ratio equals 2. When you ask the monitor to draw an
          element of 100px, it will actually draw it with a length of 200px.
      ...
      */}
      ...
      >
        ...
        <ul>
          <li>
            <b>width and height attributes</b>: They control the size of the
            image that is created and inserted in the DOM.
            <br />
        ...
        <p>
          Now, let's play with those 2 values to see what happens. In the
          examples below, a segment going from 0,0 (top left) to 100,100 is
          drawn.
        </p>

        <h3>&rarr; Small image, big output</h3>
        <p>
          If I create a small image with my canvas (100x100) and output it in
          big (300x300), the browser has to scale it up to display it, resulting
          in a blurry output
        </p>
        ...
        <p>
          Now I create a big image with my canvas (200x200) and output it in
          small (100x100), the browser has to scale it down to display it,
          &rarr; crispy output!
        </p>
      ...
      >
        ...
        <ul>
          ...
          <li>
            Use the <code>scale()</code> function in our canvas context to
            correct our coordinates
          </li>
        </ul>
        <br />
        <p>
          Here are 2 examples. The first one does not apply the correction
          (left). The second does the correction (right)
        </p>
        <div className="flex flex-col items-center">
          ...
          <Caption>
            On retina screens, the left shape is blurry when the right one is
            not.
          </Caption>
        </div>
        <p>
