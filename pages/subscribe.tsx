    ...
    >
      ...
      <div id="revue-embed">
        ...
        >
          <div>
            <input
              className="border-b-4 mr-8 py-2"
              placeholder="email"
              type="email"
              name="member[email]"
              id="member_email"
          ...
          <div>
            <input
              ...
              id="member_submit"
              className="text-md py-2 px-4 bg-reactGallery hover:bg-reactGallery text-white rounded m-1 cursor-pointer border-reactGallery border"
            ></input>
          </div>
        </form>
      </div>
      ...
      <p className="mb-8 mt-24">
        You will only receive my dataviz related content and can unsubscribe at
        any time.
      </p>
      <Contact />
    </Layout>
